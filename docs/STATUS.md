...
Briefs to write first, along the critical path: MOD7 (MOD5 and MOD6 are done). ANC1 can go in parallel; it should also measure the DMA values left open in open item 7.
